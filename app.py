...
st.sidebar.subheader("📝 Equation and Coordinate Definition")

# Dynamic string input formatting based on chosen configuration
if op == "Gradient (∇f)":
...
arrows = st.sidebar.slider("Number of Grid Arrows", 4, 15, 8)
...
if view_mode == "3D Space (X-Y-Z)":
    ...
    # 2D stable plot layout using a clean, flat 2D Scatter configuration
